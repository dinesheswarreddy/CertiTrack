...
import { Table, Container, Navbar, Button, Form, Row, Col } from 'react-bootstrap';
...
const filteredAndSortedCerts = certList
  ...
  return (
    <div className="ct-page ct-role-admin min-vh-100">
      <Navbar bg="dark" variant="dark" className="ct-topbar">
        <Container className="d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center gap-2">
            <span className="ct-seal ct-seal-sm"><i className="bi bi-shield-lock-fill" /></span>
            <h3 className="mb-0"><span className="fw-bold">Welcome, {adminName}</span></h3>
          </div>
          <div>
      ...
      <Container className="mt-4">
        <div className="ct-eyebrow mb-1">Registrar Records</div>
        <h3 className="mb-3">Internship Certificates</h3>

...
export default function InternshipStats() {
  ...
  const fetchData = async () => {
    ...
    const res = await axios.get(`${API}/api/certificates?${query}`, { headers });
  ...
  return (
    <div className="ct-page ct-role-admin">
    <Container className="py-4">
      <Button className="mb-3" variant="secondary" onClick={() => navigate('/dashboard/admin')}>
        ← Back to Dashboard
      </Button>
      <div className="ct-eyebrow text-center mb-1">Registrar Analytics</div>
      <h2 className="mb-4 text-center">Internship Statistics</h2>
      ...
      <Row className="mb-4 text-center">
        <Col><Card body className="bg-white"><div className="ct-eyebrow">Total</div><h4 className="ct-mono mb-0">{total}</h4></Card></Col>
        <Col><Card body className="bg-white" style={{ borderTop: '3px solid var(--ct-green)' }}><div className="ct-eyebrow">Paid</div><h4 className="ct-mono mb-0">{paid}</h4></Card></Col>
        <Col><Card body className="bg-white" style={{ borderTop: '3px solid var(--ct-red)' }}><div className="ct-eyebrow">Unpaid</div><h4 className="ct-mono mb-0">{unpaid}</h4></Card></Col>
        <Col><Card body className="bg-white" style={{ borderTop: '3px solid var(--ct-info)' }}><div className="ct-eyebrow">AICTE</div><h4 className="ct-mono mb-0">{aicte.length}</h4></Card></Col>
      </Row>

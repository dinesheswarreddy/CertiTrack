...
export default function FacultyLogin() {
  ...
  const sendOtp = async () => {
    try {
      const res = await axios.post(`${API}/api/password/send-otp`, { email: resetEmail });
  ...
  const verifyOtp = async () => {
    try {
      const res = await axios.post(`${API}/api/password/verify-otp`, {
        email: resetEmail,
        otp,
      });
      alert(res.data.message);
  ...
  const handlePasswordReset = async () => {
    ...
    try {
      await axios.post(`${API}/api/password/reset-password`, {
        email: resetEmail,
        newPassword: newPass,
      });
    ...
    <div className="ct-auth-wrap">
      <div className="ct-auth-card">
        <div className="ct-auth-header">
          ...
          <h3>Faculty Login</h3>
          <p>Access the faculty certificate view</p>
        </div>

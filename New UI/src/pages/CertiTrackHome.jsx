...
fetchCounts();
  ...
  return (
    <div>
      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        <div className="container">
          <Link className="navbar-brand d-flex align-items-center gap-2" to="/">
            <span className="ct-seal ct-seal-sm"><FileText size={18} /></span>
            <h2 className="mb-0">CertiTrack</h2>
          </Link>
      ...
      {/* Hero */}
      <section className="py-5" style={{ background: 'linear-gradient(180deg, #FBFAF7 0%, #F1F3F7 100%)' }}>
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6 mb-4 mb-lg-0">
              <div className="ct-eyebrow mb-2">Certification Registry</div>
              <h1 className="display-4 fw-bold" style={{ lineHeight: 1.08 }}>
                Track Student <span style={{ color: 'var(--ct-gold)' }}>Certifications</span>
              </h1>
              ...
              <div className="d-flex flex-wrap gap-3 mt-4">
                <Link to="/login/student" className="btn btn-primary btn-lg">
            ...
            <div className="col-lg-6 text-center">
              ...
              src="/home.jpg"
                ...
                style={{ boxShadow: 'var(--ct-shadow-lift)', border: '1px solid var(--ct-border)' }}
              />
            </div>
          </div>
        </div>
      ...
      {/* <footer className="py-4 bg-light border-top">
        <div className="container d-flex flex-column flex-md-row justify-content-between align-items-center">
          ...
          <footer className="mt-auto bg-white text-center py-4 border-top">
    <div class="alert alert-primary d-inline-flex align-items-center gap-4 p-3">
...
{/* <FileText size={18} className="me-2 text-primary" /> */}
            {/* <span className="fw-semibold">CertiTrack  </span> */}
             <span className="text-muted small">&copy;{new Date().getFullYear()} CertiTrack. All rights reserved.</span><br/><br/>
    <p className="text-muted small mb-0">
  Developed by{' '}
  <a
    href="https://www.linkedin.com/in/dinesheswarreddy"
    target="_blank"
  ...
  {/* &{' '}
  <a
    href="https://www.linkedin.com/in/bodaballa-jaswanth-8a85452bb"
    target="_blank"
    rel="noopener noreferrer"
  >
    Jaswanth

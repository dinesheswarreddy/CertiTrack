...
function FacultyDashboard() {
  ...
  return (
    <div className="ct-page ct-role-faculty min-vh-100">
      {/* ✅ Navbar */}
      <Navbar bg="dark" variant="dark" className="ct-topbar">
        <Container className="d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center gap-2">
            <span className="ct-seal ct-seal-sm"><i className="bi bi-person-badge" /></span>
            <h3 className="mb-0"><span className="fw-bold">Welcome, {facultyName}</span></h3>
          </div>
          <div>
      ...
      <Container className="mt-4">
        <div className="ct-eyebrow text-center mb-1">Faculty View</div>
        <h4 className="text-center mb-4">Internship Certificates</h4>
        ...
        <div className="mb-3 p-3 border rounded bg-white shadow-sm ct-filter-panel">
